...
db.serialize(() => {
    ...
    // Bảng lưu thông tin báo cơm (Chỉ còn Trưa và Tối)
...
// Thành viên Báo cơm (Đã loại bỏ cơm sáng)
...
// API 1: Thống kê tổng số suất ăn theo từng ngày (Trưa, Tối) của toàn đơn vị
